  ...
  <body>
    ...
    <script>
      const CONFIGURATION = {
        ...
        "mapOptions": {"center":{"lat":36.7943835,"lng":3.0523634},"fullscreenControl":true,"mapTypeControl":false,"streetViewControl":false,"zoom":14,"zoomControl":true,"maxZoom":20,"mapId":""},
        "mapsApiKey": "AIzaSyB7JVEqEGOuXZcf_0oruZDMHuw3ZgZZ2oo"
      };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7JVEqEGOuXZcf_0oruZDMHuw3ZgZZ2oo&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_commutes_v2_c" async defer></script>
  </body>
</html>